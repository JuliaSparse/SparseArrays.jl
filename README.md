...
You need to build Julia from scratch to use the git version (or other version) of this package. The build process is the same, the dep needs to be manually select the commit in `stdlib/SparseArrays.version`.
